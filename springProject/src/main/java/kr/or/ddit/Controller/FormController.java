...
public class FormController {
	...
	public String registerForm03(@ModelAttribute("mamVO") MemVO memVO, Model model) {
	...
	//요청URI : /form/register
	//방식 : post
	//파라미터 : {"memId":"gaeddongi","memName":"개똥이","password":"java","introduction":"소개글","hobbyList":"[01,03]"}
