...
<!-- 스프링 시큐리티 표현식
	- 인증 및 권한 정보에 따라 화면을 동적으로 구성할 수 이쏙, 로그인 한 사용자 정보를 보여줄 수 있음.
...
<!-- 
	...
	- claa="modal"이 div가 모달의 전체를 포함한 가장 큰 껍데기
 -->
          ...
          <div class="bd-example">
           ...
           <ul class="list-group list-group-flush">
             ...
             <li class="list-group-item">
                 ...
                 <input type="text" class="form-control" id="memAddr" value="<sec:authentication property="principal.memberVO.memZip" /><sec:authentication property="principal.memberVO.memAdd1" /><sec:authentication property="principal.memberVO.memAdd2" />">
             </li>
             <li class="list-group-item">
