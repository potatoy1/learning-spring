...
$(function(){
   ...
   $("#add1").on('click', function(){
      ...
      hs.append('<div class="form-group ab" id="attach'+ count + '">
      <input id="attachVOList' + count + '.filename" name="attachVOList[' + count + '].filename" placeholder="첨부파일" 
      class="form-control form-control-user" type="text"></div>');
   });
                    ...
                    <div class="p-5">
                        ...
                        <form:form modelAttribute="memVO" class="user" method="post" 
                               action="/previews/writePost" onsubmit="return fn_chk()" >
                                ...
                                <!-- 첨부파일 추가 -->
                                <button type="button" id="add1" class="btn btn-success btn-circle btn-sm">
                                        <i class="fas fa-check"></i>
                                </button>
                                <!-- 첨부파일 제거-->
                                <button type="button" id="rm1" class="btn btn-danger btn-circle btn-sm">
